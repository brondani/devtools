...
# Get cbuild2cmake
cbuild2cmake_version="0.9.0-devint0"
...
# Get cbridge
cbridge_version="0.9.3-devint0"
cbridge_base=https://github.com/brondani/generator-bridge/releases/download/v${cbridge_version}/cbridge_${cbridge_version}
...
# Get csolution
csolution_version="2.3.0-devint0"
